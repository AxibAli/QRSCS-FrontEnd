...
function htmlToPDF() {
    ...
    var y = 20;
    doc.setLineWidth(2);
    doc.text(200, y = y + 30, "CGPA OF STUDENTS FROM DIFFERENT CITIES");
    doc.autoTable({
        html: '#simple_table',
        startY: 70,
        theme: 'grid',
...
function printTable() {
    ...
    var table = document.getElementById("simple_table"); //get table 
    ...
    win.document.write(footer.outerHTML);                       //   write table to new window
